...
if(TARGET GTest::gtest)
    get_property(GTEST_LOCATION TARGET GTest::gtest PROPERTY LOCATION)
...
if(TARGET GTest::gmock)
    get_property(GMOCK_LOCATION TARGET GTest::gmock PROPERTY LOCATION)
...
function(TARGET_ADD_TESTS)
    ...
    cmake_parse_arguments(
        P "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN}
    )
    target_link_libraries(
        ${P_TARGET} PRIVATE GTest::gtest GTest::gtest_main GTest::gmock
                            GTest::gmock_main
    )
